...
export default function CVTimeline() {
  ...
  useEffect(() => {
    ...
    // Phase 1 uses ~1.2 screens of scroll for the entrance (rise from bottom)
    const ENTRANCE_SCREENS = 1.2;
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(to right, transparent, rgba(255,255,255,0.06) 5%, rgba(255,255,255,0.06) 95%, transparent)",
              }}
            />
                ...
                >
                  ...
                  <div className="absolute top-1/2 left-0 -translate-y-1/2 z-10">
                    <div
                      ...
                      style={{
                        boxShadow:
                          "0 0 0 4px rgba(163, 230, 53, 0.18)",
                      }}
                    />
                  </div>
